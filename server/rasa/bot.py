...
class ActionSearchItems(Action):
    def name(self):
...
class ActionSuggest(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        dispatcher.utter_message("a jacket")
        return []

class ShopPolicy(KerasPolicy):
...
def train_dialogue(domain_file="shop_domain.yml",
    ...
    agent = Agent(domain_file,
                  policies=[MemoizationPolicy(), ShopPolicy()])
